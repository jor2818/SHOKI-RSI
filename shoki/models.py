...
class Rsi(db.Model):
    ...
    trip_purpose = db.Column(db.Integer,nullable=False)
    passenger12 = db.Column(db.Integer,nullable=True)
    passenger34 = db.Column(db.Integer,nullable=True)
    passenger58 = db.Column(db.Integer,nullable=True)
    cargo_type = db.Column(db.Integer,nullable=True)
    cargo_weight = db.Column(db.Integer,nullable=True)
